...
async function loginUser(req, res) {
  ...
  try {
    ...
    const userData = {
      ...
      } else if (user.role === 'LABTECHNICIAN' && user.labTechnicianId) {
        const labtechnician = await prisma.labtechnician.findUnique({
          where: { id: user.labTechnicianId },
        });
        Object.assign(userData, { labTechnicianId: user.labTechnicianId, fullName: labtechnician.fullName, profilePicture:labtechnician.profilePicture });
